  ...
  story_coach: [
    {
      icon: "📖",
      title: "欢迎使用故事教练",
      description: "用英雄之旅的方法，把你的经历变成动人的成长故事。"
    },
    {
      icon: "🌪️",
      title: "英雄之旅四部曲",
      description: "通过四个阶段创作故事：问题→转折→成长→反思。",
      details: [
        "问题：故事的开始，遇到的挑战",
        "转折：关键时刻，新的思考与选择",
        "成长：经历之后，对自己的新认识",
    ...
    },
    {
      icon: "✨",
      title: "分享你的故事",
      description: "完成创作后可以分享到社区，让更多人从你的故事中获得力量。"
    }
  ],
  ...
  vibrant_life_coach: [
    {
      icon: "❤️",
      title: "欢迎使用有劲生活教练",
      description: "我是你的智能总入口，帮你找到最适合的成长资源。"
    },
    {
      icon: "💬",
      title: "三步交互模式",
      description: "共情陪伴 → 即时技巧 → 资源推荐，自然流畅的对话体验。",
      details: [
        "共情陪伴：先理解你的感受",
        "即时技巧：提供30秒可用的小技巧",
        "资源推荐：推荐最适合的教练或工具"
    ...
    },
    {
      icon: "📞",
      title: "语音对话",
      description: "点击语音按钮，像打电话一样自然对话，随时随地获得支持。"
    }
  ],
  ...
  human_coaches: [
    {
      icon: "👨‍🏫",
      title: "欢迎来到真人教练",
      description: "这里有专业的真人教练提供一对一咨询服务，给你更深度的陪伴。"
    },
    {
      icon: "🔍",
      title: "搜索和筛选",
      description: "使用搜索框查找教练，或按专业领域筛选，找到最适合你的教练。"
    },
    {
      icon: "⭐",
      title: "智能推荐",
      description: "系统会根据你的需求智能推荐合适的教练，帮你快速找到匹配的专家。"
    },
    {
      icon: "💼",
      title: "成为教练",
      description: "如果你有专业资质，也可以申请成为有劲平台的认证教练。"
    }
  ],
  ...
  human_coach_detail: [
    {
      icon: "📋",
      title: "教练详情页",
      description: "在这里了解教练的背景、资质、服务项目和用户评价。"
    },
    {
      icon: "🎯",
      title: "选择服务",
      description: "查看教练提供的不同服务项目，选择适合你的咨询类型。"
    },
    {
      icon: "📅",
      title: "预约流程",
      description: "点击「立即预约」选择时间段，支付后即可等待教练确认。"
    },
    {
      icon: "📞",
      title: "语音通话",
      description: "预约成功后，可以在约定时间通过平台进行语音通话咨询。"
    }
  ],
  ...
  teen_coach: [
    {
      icon: "✨",
      title: "嗨，欢迎来到你的空间",
      description: "这里是属于你的安全角落，你可以和AI小星分享任何事。"
    },
    {
      icon: "🔒",
      title: "完全私密",
      description: "你说的话只有AI知道，100%保密，爸妈看不到具体内容。"
    },
    {
      icon: "🎙️",
      title: "语音对话",
      description: "点击「开始语音对话」，就像和朋友打电话一样，随时倾诉你的心事。"
    }
  ],

  // 有劲生活历史
  vibrant_life_history: [
    {
      icon: "❤️",
      title: "我的生活记录",
      description: "这里保存了你和有劲AI的所有对话摘要和推荐记录。"
    },
    {
      icon: "📖",
      title: "查看详情",
      description: "点击任意卡片，可以查看完整的对话内容和AI推荐。"
    }
  ]
};
