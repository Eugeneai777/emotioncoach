  ...
  bloom_partner_intro: [
    {
      icon: "🌸",
      title: "欢迎来到绽放合伙人",
      description: "这里是你开启绽放之旅的入口，三大核心权益一站式了解。",
      details: [
        "绽放合伙人计划：训练营 + 教练辅导 + 分销佣金",
        "财富卡点测评：发现潜意识财富信念卡点",
        "财富觉醒训练营：7天系统训练 + AI教练陪伴"
      ]
    },
    {
      icon: "🎯",
      title: "三大核心权益",
      description: "每张卡片对应一项权益，点击即可进入详情页面深入了解。",
      details: [
        "🌸 绽放合伙人：全方位成长 + 分销收益",
        "🎯 财富卡点测评：30道深度测评找到卡点",
        "✨ 财富觉醒训练营：每日冥想 + 系统训练"
    ...
    },
    {
      icon: "📱",
      title: "如何开始",
      description: "先登录或注册账号，然后点击感兴趣的卡片即可进入对应功能。",
      details: [
        "未登录时点击卡片会自动跳转注册页",
        "登录后可直接访问所有权益内容"
      ]
