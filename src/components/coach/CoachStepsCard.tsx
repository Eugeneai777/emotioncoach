    ...
    <div className="bg-card border border-border rounded-2xl p-4 md:p-6 space-y-3 md:space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2 md:gap-3">
        {steps.map((step) => (
          ...
          >
          <CollapsibleTrigger className={`w-full bg-background/50 rounded-card p-card-sm border border-border/50 hover:border-${primaryColor}/30 transition-all duration-200 group cursor-pointer text-left`}>
