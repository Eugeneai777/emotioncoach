      ...
      <div className="grid grid-cols-2 gap-2 md:gap-3">
        {steps.map((step) => (
          ...
          <button 
            ...
            className={`w-full bg-background/50 rounded-card p-card-sm border border-border/50 hover:border-${primaryColor}/30 transition-all duration-200 group cursor-pointer text-left`}
          >
