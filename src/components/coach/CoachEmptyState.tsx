        ...
        <div className="bg-card border border-border rounded-card-lg p-card text-left shadow-md hover:shadow-lg transition-shadow duration-300 animate-in fade-in-50 slide-in-from-bottom-6 duration-700 delay-200">
          <div className="w-full flex items-center justify-between">
            <button 
              ...
              className="flex-1 flex items-center gap-1.5 cursor-pointer text-left bg-transparent border-0 p-0 outline-none focus:outline-none"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                type="button"
                onClick={() => setIsStepsCardExpanded(!isStepsCardExpanded)}
                className="cursor-pointer bg-transparent border-0 p-0 outline-none focus:outline-none"
              >
              ...
              {steps.map((step) => (
                ...
                >
                  <button 
                    ...
                    className="w-full bg-background/50 rounded-card p-card-sm border border-border/50 hover:border-primary/30 transition-all duration-200 group cursor-pointer text-left"
                  >
