...
export const ThemeRadarChart = ({
  themeStats
}: ThemeRadarChartProps) => {
      ...
      <div className="h-[280px]">
        <ResponsiveContainer width="100%" height="100%">
          ...
          left: 30
            ...
            <PolarAngleAxis dataKey="theme" tick={{
            fontSize: 11,
            fill: "hsl(var(--foreground))"
          }} />
            <PolarRadiusAxis angle={30} domain={[0, "dataMax"]} tick={{
            fontSize: 10
          }} />
            <Radar name="主题出现次数" dataKey="value" stroke="hsl(var(--primary))" fill="hsl(var(--primary))" fillOpacity={0.5} />
