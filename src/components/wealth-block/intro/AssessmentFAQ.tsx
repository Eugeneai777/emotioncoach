...
const faqItems = [
  ...
  {
    q: "AI 语音教练是怎么工作的？",
    a: "完成测评后，你可以直接与 AI 财富教练进行 1 对 1 语音对话。教练会基于你的测评结果，逐条解析你的卡点成因，并给出个性化的突破建议。就像和一位懂你的教练面对面交流一样自然。",
  },
  {
    q: "觉醒顾问能帮我什么？",
    a: "觉醒顾问是你专属的成长伙伴。完成测评后，顾问会为你制定 7 天定制觉醒路径，每天一个小步骤帮你逐步突破。你还可以随时找顾问 1 对 1 对话，不限次数地倾诉困惑、获取指导。",
  },
  {
    q: "我的测评数据安全吗？",
