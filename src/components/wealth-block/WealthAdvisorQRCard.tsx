...
export function WealthAdvisorQRCard({ reactionPattern, dominantPoor }: WealthAdvisorQRCardProps) {
  ...
  return (
    ...
    >
      {/* Pulse glow border */}
      <div className="absolute -inset-[2px] rounded-2xl bg-gradient-to-r from-violet-500/60 via-amber-400/60 to-violet-500/60 animate-pulse blur-sm" />
      ...
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1e1045] via-[#2d1b69] to-[#1a0e3a] p-5 sm:p-6">
        ...
        <div className="text-center mb-4">
          <p className="text-amber-300/80 text-xs tracking-widest mb-1">✦ 专属顾问 ✦</p>
          <h3 className="text-lg sm:text-xl font-bold text-white">你的财富觉醒顾问</h3>
        </div>
