...
const KNOWN_SHARE_FEATURES: AuditItem[] = [
  ...
  },
  {
    ...
    name: 'EmotionButtonShareDialog',
    filePath: 'src/components/tools/EmotionButtonShareDialog.tsx',
    status: 'compliant',
    registeredInRegistry: true,
    usesUnifiedModule: true,
    usesUnifiedQR: true,
    usesUnifiedDomain: true,
    notes: '使用 generateCardBlob + getPromotionDomain',
  },
  {
    id: 'wealth-journal-share',
    name: 'WealthJournalShareDialog',
    filePath: 'src/components/wealth-camp/WealthJournalShareDialog.tsx',
    status: 'compliant',
    registeredInRegistry: true,
    usesUnifiedModule: true,
    usesUnifiedQR: true,
    usesUnifiedDomain: true,
    notes: '使用 generateCanvas + getShareEnvironment',
  },
  // 部分合规
  {
    id: 'partner-plan',
  ...
  },
  {
    ...
    name: 'GratitudeJournalShareDialog',
    filePath: 'src/components/gratitude/GratitudeJournalShareDialog.tsx',
    status: 'compliant',
    registeredInRegistry: true,
    usesUnifiedModule: true,
    usesUnifiedQR: true,
    usesUnifiedDomain: true,
    notes: '已修复为 useQRCode hook',
  },
  {
    id: 'camp-checkin',
    name: 'CampShareDialog',
    filePath: 'src/components/camp/CampShareDialog.tsx',
    status: 'partial',
    registeredInRegistry: true,
    usesUnifiedModule: false,
    usesUnifiedQR: false,
  ...
  {
    id: 'briefing-share',
    name: 'BriefingShareDialog',
    filePath: 'src/components/briefing/BriefingShareDialog.tsx',
    status: 'partial',
    registeredInRegistry: true,
    usesUnifiedModule: false,
    usesUnifiedQR: false,
  ...
  },
  {
    ...
    name: 'AliveCheckShareDialog',
    filePath: 'src/components/tools/AliveCheckShareDialog.tsx',
    status: 'compliant',
    registeredInRegistry: true,
    usesUnifiedModule: true,
    usesUnifiedQR: true,
