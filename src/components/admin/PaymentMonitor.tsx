...
import { AlertTriangle, TrendingDown, TrendingUp, Clock, AlertCircle, ArrowUpRight, ArrowDownLeft } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{paymentMetrics.conversionRate.toFixed(1)}%</div>
