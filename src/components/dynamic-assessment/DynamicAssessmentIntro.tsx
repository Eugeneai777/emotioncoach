...
const enrichmentData: Record<string, {
  ...
  male_midlife_vitality: {
    painPoints: [
      { emoji: "🌪️", text: "看一张图、听一段声音,身体先紧绷起来——你都没意识到" },
      { emoji: "🌙", text: "闹钟一响,像被卡车碾过又被拼回来" },
      { emoji: "📱", text: "晚上 11 点老板一句\"在吗\",心脏先漏一拍" },
      { emoji: "🚪", text: "半开的门后,直觉在等你交代什么——这就是心因焦虑" },
    ],
    authority: [
      { emoji: "🔒", text: "私密完成:结果只给你自己看,不需要向任何人解释" },
      { emoji: "🧭", text: "有依据:围绕神经紧绷、慢性疲劳、情绪底色、心因焦虑、核心动力 5 维度盘点" },
      { emoji: "🛡️", text: "非诊断:不贴标签;如有明显身体不适,建议及时咨询专业医生" },
    ],
    comparison: {
      traditional: "题目太医学化,越看越紧张;或者太娱乐化,看完还是不知道该怎么办。",
      ours: "用图 / 声音 / 颜色 / 场景 4 类多模态题,5 分钟看清你的「神经紧绷-疲劳-情绪-焦虑-动力」链路。",
    },
    scene: {
      image: midlifeVitalitySceneImage,
      title: "很多变化,不是突然发生的",
      subtitle: "先看清状态,再决定从哪里开始恢复。",
      tags: ["神经紧绷", "睡不深", "关键时刻心慌", "提不起劲"],
    },
    radarPreview: [
      { score: 62, maxScore: 100, label: "神经紧绷", emoji: "🌪️" },
      { score: 48, maxScore: 100, label: "慢性疲劳", emoji: "🌙" },
      { score: 55, maxScore: 100, label: "情绪底色", emoji: "🎨" },
      { score: 58, maxScore: 100, label: "心因表现焦虑", emoji: "🚪" },
