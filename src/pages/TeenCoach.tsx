  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="懂你的AI朋友，不说教、不评判，只是陪你聊聊" />
        <meta property="og:title" content="有劲AI｜青少年专属AI伙伴" />
        <meta property="og:description" content="安全私密的倾诉空间，24小时陪伴，帮你度过成长的困惑" />
