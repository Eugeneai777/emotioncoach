      ...
      <main className="container max-w-4xl mx-auto px-4 py-8 space-y-12">
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">01｜什么是「情绪🆘按钮」？</h2>
          </div>
          
          <Card className="bg-white/70 backdrop-blur border-teal-100">
            <CardContent className="p-6 space-y-6">
              <p className="text-gray-700 leading-relaxed">
                情绪🆘按钮是一套基于 <span className="font-semibold text-teal-700">神经科学 + 临床心理学 + 呼吸调节学 + 认知科学</span> 的
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            <span className="text-2xl">🧠</span>
            <h2 className="text-2xl font-bold text-gray-900">02｜为什么情绪🆘按钮有效？（科学依据 & 机构支持）</h2>
          </div>

          <p className="text-gray-700 leading-relaxed">
            情绪🆘按钮不是「喊喊口号就好一点」的心理安慰，而是整合了多种经实证支持的方法。
          </p>
          ...
          <Card className="bg-white/70 backdrop-blur border-l-4 border-l-teal-500 border-teal-100">
            <CardContent className="p-6 space-y-4">
              ...
              <div className="bg-teal-50/80 rounded-xl p-4">
                <p className="text-gray-700">
                  情绪🆘按钮内置了简单的 <span className="font-semibold text-teal-700">「4–6 呼吸法」</span>：<br />
          ...
          <Card className="bg-white/70 backdrop-blur border-l-4 border-l-indigo-500 border-indigo-100">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-gray-700">因此，情绪🆘按钮的最后一步通常会请你做一个极小、几乎不会失败的动作，例如：</p>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 font-semibold text-center py-4">
            情绪🆘按钮就是沿着这条「真实的大脑路径」在工作，而不是凭感觉安慰你。
          </p>
        </section>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            <span className="text-2xl">🎯</span>
            <h2 className="text-2xl font-bold text-gray-900">04｜为什么情绪🆘按钮之后，一定要接上「情绪教练」？</h2>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">05｜情绪🆘按钮怎么用？（超简单 5 步）</h2>
          </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-3">
            <span className="text-2xl">🧩</span>
            <h2 className="text-2xl font-bold text-gray-900">06｜情绪🆘按钮 + 情绪教练 = 一条完整的路</h2>
          </div>
            ...
            <CardContent className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="text-center space-y-3">
                  ...
                  <h4 className="font-bold text-teal-700">情绪🆘按钮</h4>
