          ...
          {isFilterLoading ? (
            ...
            <div className="text-center py-16 space-y-3">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Button variant="outline" onClick={() => navigate('/assessment-tools')}>探索测评</Button>
              </div>
            </div>
          ) : (
            <>
              ...
              {filterParam === 'my' && (
                <section>
                  ...
                  <div className="pt-3 text-center">
                    <Button variant="outline" size="sm" onClick={() => navigate('/assessment-tools')} className="gap-1.5 text-xs">
                      <Sparkles className="w-3.5 h-3.5" />
                      浏览更多测评
                    </Button>
                  </div>
