...
const UserManual = () => {
  ...
  const studioModules = [
    ...
    },
    {
      ...
      features: ["情绪🆘按钮（9种情绪即时疗愈）", "能量宣言卡", "呼吸练习", "感恩日记", "习惯追踪"]
    },
    {
      icon: Video,
      emoji: "📚",
  ...
  const toolCategories = [
    {
      ...
      title: "情绪工具",
      color: "purple",
      tools: ["情绪🆘按钮（9种情绪即时疗愈）", "能量宣言卡", "呼吸练习", "正念冥想", "频率疗愈"]
    },
    {
      emoji: "💚",
      title: "自我探索",
  ...
  const structureMap = [
    ...
    },
    {
      emoji: "🛠️",
      title: "成长工具",
      items: ["情绪工具（情绪🆘按钮为核心）", "自我探索工具", "生活管理工具"],
      color: "purple"
    },
    {
      emoji: "📚",
  ...
  const dailyFlow = [
    ...
    },
    {
      ...
      features: ["情绪🆘按钮（即时缓解）", "情绪教练（深度梳理）", "语音对话（随时随地）"],
  ...
  const additionalFeatures = [
    { icon: Shield, title: "情绪🆘按钮", description: "9种情绪即时疗愈", gradient: "from-teal-500 to-cyan-500" },
  ...
  const faqs = [
    {
      q: "情绪🆘按钮和情绪教练有什么区别？",
      a: "情绪🆘按钮是即时的陪伴，适合情绪激动时快速获得认知提醒和稳定；情绪教练是深入的梳理，适合有时间时系统性地处理情绪。两者配合使用效果最佳。"
    },
    {
      q: "如何选择合适的教练？",
    ...
    {
      q: "必须每天使用吗？",
      a: "不需要强制每天使用，但持续使用效果更好。建议至少保持情绪🆘按钮和感恩日记的使用习惯。"
    },
    {
      q: "训练营和自由使用有什么区别？",
