            ...
            {[
              {
                ...
                title: "资深教练腾讯会议 30 分钟 · 不是讲给你听，是陪你看见",
                desc:
                  "先把你这一年到底是哪一格在掉电——白天没劲、夜里睡不沉、关键场合发虚、回家就想一个人待着——一项一项摆出来。\n\n测完 48 小时内，资深教练用腾讯会议跟你 1 对 1 坐 30 分钟。不是老师把答案讲给你听，是教练用一组一组的问题陪你慢慢看：哪一项你早就感觉到了、哪一项被忽略很久、哪一项你想先动——你说，他听，他再问。\n\n会议全程录下来、AI 自动整理纪要发你手机，过两周想再看一遍随时翻。",
              },
              {
                Icon: Pill,
              ...
              },
              {
                ...
                desc:
                  "7 天走完，不是发个证书就散。\n\n资深教练用腾讯会议再跟你 1 对 1 坐 45 分钟。还是教练式对话——结合你这 7 天写下的话 + 第 1 天那份报告，他一组一组地问你：接下来这半年，你最想先动的，到底是哪一件。\n\n这一场也录下来、AI 出纪要，存你手机里。",
              },
            ].map((card, i) => (
              <div
                key={i}
