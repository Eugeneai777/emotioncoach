      ...
      <div className="mx-auto max-w-[480px]" style={{ background: C.bgSoft }}>
        ...
        <Section index={6} eyebrow="我们懂你的在意" title="4 条不可妥协的隐私承诺">
          ...
          <div className="space-y-3">
            {[
              { t: "腾讯会议只你和教练", d: "录像只发你本人 · 不进群、不外传" },
              { t: "课程链接仅本人可看", d: "不可分享转发，链接绑定账号" },
              { t: "AI 教练对话仅你可见", d: "深夜也在 · 平台不留浏览记录" },
        ...
        <Section index={7} eyebrow="先走一步的他们，说了这些" title="同龄人，不是鸡汤">
          <div className="space-y-4">
            {[
              ...
              {
                name: "陈先生 · 52 岁 · 工程师",
                quote: "那次 1 对 1 之后我才意识到 —— 原来不是身体先好，是先敢面对。",
              },
              {
                name: "李先生 · 41 岁 · 销售总监",
        ...
        <Section index={8} eyebrow="解决最后顾虑" title="你可能想问的 4 个问题">
          ...
          >
            <Accordion type="single" collapsible className="w-full">
              ...
              {
                  q: "怎么上课？要请假吗？",
                  a: "全程线上。两次 1V1 用腾讯会议，时间提前跟专属顾问约，避开你的会和应酬。每天那 15 分钟自己挑时间，地铁上、午休、睡前都行。两次会议都录像，AI 出纪要发你手机，过两周想再看一遍随时翻。",
                },
                {
                  q: "会不会被同事或家里人看到？",
                  a: "知乐胶囊顺丰匿名包装，外箱不写「情绪」「男士」任何字眼。两次腾讯会议只有你和总教练两个人，录像只发给你本人，不进群、不外传。AI 男士教练深夜也在，不留浏览记录。",
                },
                {
                  q: "我不会用太多 APP，会不会很麻烦？",
                  a: "不用。付款后专属顾问加你微信，把课程链接、学员群、胶囊物流一次性安排好。开营前一晚再提醒你一次，你跟着节奏走就行。",
                },
                {
                  q: "AI 教练能随时聊吗？真人教练怎么联系？",
                  a: "AI 男士教练 24 小时在线，深夜也能问，不留浏览记录。两次 1V1 由总教练通过腾讯会议跟你单独聊。中间想加问、改时间，找你的专属顾问就行，不打官腔。",
                },
              ].map((item, i, arr) => (
                <AccordionItem
                  key={i}
