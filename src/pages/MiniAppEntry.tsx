...
const audiences: Array<{
  ...
  { id: "mama", emoji: "👩", label: "女性专区", subtitle: "懂你也懂生活", route: "/mama", gradient: "from-rose-500 to-pink-400", badge: {
    ...
    assessments: [
      ...
      { emoji: "💚", title: "情绪健康测评", sub: "PHQ-9+GAD-7·5分钟", route: "/emotion-health-lite", price: "免费" },
    ],
  }},
...
const useCases = [
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-sky-500/15 to-cyan-500/8",
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-yellow-500/15 to-amber-500/8",
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-slate-500/15 to-zinc-500/8",
...
const testimonials = [
  { quote: "训练营第5天做完情绪释放练习，回家后老婆说'你今天怎么不一样了'。整个人松弛下来的感觉，太久没有过了。", name: "老王", identity: "38岁，程序员", tag: "7天有劲" },
  { quote: "7天训练营结束后，团队都说我变了。以前开会总是焦虑地抢话，现在能稳住了。焦虑模式真的可以被打破。", name: "阿杰", identity: "36岁，创业者", tag: "7天有劲" },
  { quote: "训练营里有一天的课题是'看见代际创伤'，做完练习我抱着孩子哭了。从那天起，我不再对她吼了。", name: "丽姐", identity: "38岁，教师", tag: "7天有劲" },
  { quote: "做完财富信念测评，才发现我一直在'我配不上'的信念里打转。9块9测出了困扰我十几年的卡点。", name: "大伟", identity: "40岁，工程师", tag: "财富测评" },
  { quote: "财富测评结果显示我有'赚钱=辛苦'的深层信念，难怪每次收入上台阶就自我破坏。看清了就好办了。", name: "老陈", identity: "42岁，中层管理", tag: "财富测评" },
  { quote: "情绪健康测评让我第一次正视自己长期压抑的感受。原来我不是'没事'，是已经麻木了。测完当天就决定开始改变。", name: "芳芳", identity: "32岁，全职妈妈", tag: "情绪测评" },
  { quote: "一直觉得自己抗压能力强，做完情绪测评才知道我的压力指数已经到了临界点。幸好及时发现，开始调整了。", name: "阿明", identity: "35岁，销售", tag: "情绪测评" },
  { quote: "¥3980报了身份绽放训练营，说实话犹豫了很久。但16节课下来，我找回了对生活的掌控感，这个投入太值了。", name: "张哥", identity: "45岁，企业主", tag: "身份绽放" },
  { quote: "身份绽放训练营让我重新定义了'我是谁'。以前总活在别人的期待里，现在终于敢为自己而活了。", name: "思思", identity: "33岁，HR", tag: "身份绽放" },
  { quote: "训练营每天的能量练习只要15分钟，但坚持7天下来，同事说我整个人气场都变了。399花得值。", name: "小林", identity: "30岁，设计师", tag: "7天有劲" },
];

// 精选5条见证（覆盖4个核心产品：训练营×2 + 情绪测评 + 身份绽放 + 财富测评）
const featuredTestimonials = [
  testimonials[0],  // 老王 - 7天有劲训练营
  testimonials[1],  // 阿杰 - 7天有劲训练营
  testimonials[5],  // 芳芳 - 情绪健康测评
  testimonials[7],  // 张哥 - 身份绽放训练营
  testimonials[3],  // 大伟 - 财富信念测评
];
