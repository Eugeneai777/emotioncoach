...
不要急着问问题,先让父母感受到被接纳。`;
        case 1:
          return `【觉察（Feel it）：从"情绪被动"到"情绪被看见"】
...
当父母从"孩子惹我生气"变成"是我内在的焦虑被触发了"时，记录洞察并调用complete_stage。`;
        case 2:
          return `【看见（See it）：从"怪孩子"到"我和孩子都在卡点里"】
...
当父母能讲出"原来我越控制，他越逃避"这样的洞察句时，记录洞察并调用complete_stage。`;
        case 3:
          return `【反应（Sense it）：从"自动反应"到"有选择的反应"】

成功标准（观察到以下任意1项即可调用complete_stage）:
✔ 能表达"我可以试试先暂停5秒"
✔ 能说出："我刚刚的反应是为了掩盖我的焦虑"
✔ 能分辨自己的反应（焦虑、催逼）和孩子的反应（逃避、沉默）

引导方向:
- "下次遇到这个情况，你觉得你能暂停5秒吗？就5秒。"
- "如果你暂停5秒，然后告诉孩子'我需要冷静一下'，你觉得会发生什么？"
- "你有没有发现，你的反应其实是在保护自己不去面对某种害怕？"

判断成功:
当父母第一次说出"我可以试试先暂停"或"我的反应是为了..."时，记录洞察并调用complete_stage。`;
        case 4:
          return `【转化（Transform）：从"情绪拉扯"到"关系松动1mm"】
...
引导方向:
- "有没有一件很小很小的事，你今天就可以试试？"
- "你能不能想象一下，如果你做了这件小事，孩子可能会有什么反应？"
- "成功不是孩子马上改变，而是你感觉到心松了一点点"
...
【4步曲：从情绪被动到关系松动】
1️⃣ 觉察（Feel it）：从"情绪被动"到"情绪被看见"
2️⃣ 看见（See it）：从"怪孩子"到"我和孩子都在卡点里"
3️⃣ 反应（Sense it）：从"自动反应"到"有选择的反应"
4️⃣ 转化（Transform）：从"情绪拉扯"到"关系松动1mm"
