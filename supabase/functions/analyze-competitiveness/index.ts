...
## 👑 你的竞争力画像
（2-3句话精准描述她是什么类型的35+女性，用温暖有力的语言）

## 💪 你的隐藏优势
（基于最强维度，挖掘她可能没意识到的优势，2-3点）

## 🔓 突破口在这里
（基于最弱维度，分析根因并给出具体突破方向，不要泛泛而谈）

## 🎯 3个行动建议
（具体可执行的行动步骤，每个步骤包含：做什么、怎么做、预期效果）

## 💌 写给你的话
（一段温暖有力量的鼓励，让她感受到35+不是终点而是新起点）

注意：不要返回 JSON，直接返回 Markdown 格式的文本。`;
