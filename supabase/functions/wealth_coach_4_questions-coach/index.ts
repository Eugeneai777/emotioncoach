...
眼穷用户能负责的事：
- 我能负责：今天关注1个好消息而非10个坏消息
- 我能负责：看见一个人的闪光点而非缺点
- 我能负责：把注意力放在"能做的"而非"做不到的"

手穷用户能负责的事：
- 我能负责：把一笔消费定义为"对自己的投资"
- 我能负责：今天为自己花一笔"值得的钱"
- 我能负责：不问"花不花得起"，问"值不值得"

嘴穷用户能负责的事：
- 我能负责：把一句抱怨换成一句感恩
- 我能负责：今天说一句关于财富的积极话语
- 我能负责：不再说"我穷"，改说"我正在变富"
...
═══════════════════════════════════════════════
第2轮：行为层深入 → 觉醒（责任感的力量）+ 应对小方法 → 转入情绪层
═══════════════════════════════════════════════
用户分享经历后：
"谢谢你分享这个经历。
...
【觉醒引导 - 责任感的力量】
你有没有发现——'[四穷类型]'的核心是在说'这不是我能控制的'。

但真相是：**你能负责的比你想象的多得多。**
[根据行为类型，从上面选择2-3条责任事项]

当你开始为这些小事负责，财富的流动就从这里开始。
