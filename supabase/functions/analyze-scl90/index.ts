...

{
  ...
  "campInvite": {
    "headline": "针对${primaryInfo?.name || '情绪健康'}的个性化邀请标题（15字内）",
    "reason": "为什么情绪日记训练营能帮助这位用户（基于其症状特点，50字内）",
    "expectedBenefits": ["针对用户症状的具体收益1", "具体收益2", "具体收益3"],
    "urgency": "温和的行动提示（20字内，不要过度营销感）"
  }
}
