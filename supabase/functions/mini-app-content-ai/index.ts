  ...
  "items": [
    {
      ...
      "voiceoverTitle": "对应口播稿标题",
      "voiceoverScript": "对应短视频口播稿，45-75秒，口语化可直接念",
      "voiceoverShots": ["镜头1建议", "镜头2建议", "镜头3建议"],
      "route": "推荐入口路径",
      "topicId": "可选主题ID",
      "productId": "可选转化产品ID"
    }
...
- 当用户要求“同时生成口播稿版本”时，必须补全 voiceoverTitle、voiceoverScript、voiceoverShots。口播稿要基于同一条小红书图文稿改写，保留同一个痛点、赠品、报告价值和私域 CTA，不能生成成另一条选题。
- voiceoverScript 结构：3秒开场冲突 + 用户共鸣 + 1-2个洞察/方法 + 限时赠品 + 私信/加企微引导；不要分镜脚本腔，要像真人能直接念。
