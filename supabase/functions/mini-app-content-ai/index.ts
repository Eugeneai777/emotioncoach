...
- giftProductName 必须是标准产品/工具名，例如“财富卡点测评”“情绪SOS按钮”“7天有劲训练营”，不要改名。
- giftDisplayName 必须包含标准产品/工具名，例如“限时赠送「财富卡点测评」”。
...
- matchedTool 不要只写“财富卡点测评”，要写成“财富卡点测评：定位你存不下钱背后的核心信念”。
