...
const AUDIENCE_PROMPTS: Record<string, string> = {
  ...
  youth: "Generate a flat-style illustration for a mental health mini-program card: a young student with a backpack looking at the sky with hope, soft amber and orange tones, minimalist youthful style, no text, no real faces, square composition, suitable for a mobile card thumbnail.",
  midlife: "Generate a flat-style illustration for a mental health mini-program card: a person standing at a crossroads looking forward with determination, warm orange and red tones, minimalist contemplative style, no text, no real faces, square composition, suitable for a mobile card thumbnail.",
  senior: "Generate a flat-style illustration for a mental health mini-program card: an elderly person in a garden surrounded by green plants, soft emerald and teal tones, minimalist peaceful style, no text, no real faces, square composition, suitable for a mobile card thumbnail.",
};
