...
-- Add id_card fields to orders table
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS id_card_name text;
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS id_card_number text;

-- Recreate get_zhile_orders function to read actual id_card fields from orders
